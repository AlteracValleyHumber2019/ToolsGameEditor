...
Mat3 MATH::MMath::translate3(const float x_, const float y_, const float z_)
{
	return Mat3(1.0f, 0.0f, x_,
				0.0, 1.0f,  y_,
				0.0, 0.0, 1.0f);
}
//stuff A.T did 
Mat3 MATH::MMath::scale3(const float x_, const float y_, const float z_)
{
	return Mat3( x_, 0.0, 0.0,
					0.0, y_, 0.0,
					0.0,0.0,1.0);
}

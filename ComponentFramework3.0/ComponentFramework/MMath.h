...
namespace  MATH {
	...
	public:
		...
		//stuff A.T did 
		//static Matrix3 rotate3(float degrees_, float x_, float y_, float z_);
		static Mat3 translate3(const float x_, const float y_, const float z_);
		static Mat3 scale3(const float x_, const float y_ , const float z_);

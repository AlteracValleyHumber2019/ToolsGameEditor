...
//bool GameObject::CheckCollisonSelection(Vec3& ray_origin_, Vec3& ray_end_, TestPicker& Selection_Tool_)
//{
//	if (Selection_Tool_.TestRayOBBIntersection(ray_end_, ray_end_, SelectBox[0], SelectBox[4], modelMatrix)) {
//		return true;
//	}
//	return false;
//}
